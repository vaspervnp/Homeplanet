...
; ----------------------------------------------------------------------------
;  mis_none -- a mission with no picket at all points its layout here.
;
;  THE LAYOUTS THEMSELVES ARE IN BANK 7, in game/enemylayouts.asm, and the
;  words defw'd above are addresses in that bank. Nothing dereferences them but
;  mis_setup, through bank7_copy. See that file for the arithmetic.
; ----------------------------------------------------------------------------
mis_none:
